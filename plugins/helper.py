...
BASE_URL = os.getenv("DEALPOS_BASE_URL", "https://hijacksandals.dealpos.net/api/v3")
CLIENT_ID = os.getenv("DEALPOS_CLIENT_ID", "019c9a25-05c4-7a38-b04a-dd1efe4c08ef")
CLIENT_SECRET = os.getenv("DEALPOS_CLIENT_SECRET", "019c9a26-51bf-7232-ae0a-4c702ba345e9")

DB_CONFIG = {
    "host": os.getenv("ETL_DB_HOST"),
    "port": _optional_int_env("ETL_DB_PORT"),
