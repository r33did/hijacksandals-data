...
if "subdomain" not in st.session_state:
    st.session_state.subdomain = "hijacksandals.dealpos.net"
...
with st.sidebar:
    ...
    subdomain = st.text_input("Subdomain", placeholder="hijacksandals.dealpos.net", value=st.session_state.subdomain)
